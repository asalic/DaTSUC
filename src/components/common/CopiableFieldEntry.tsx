...
function CopiableFieldEntry({ text, fontSizeText, boldText, italicText}: CopiableFieldEntryProps): JSX.Element {
    ...
    <Button  style={{fontSize, fontWeight, fontStyle }} variant="link" className="m-0 p-0 ms-1" onClick={(e) =>
            {
